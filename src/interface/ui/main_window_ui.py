...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.table_widget_main = QTableWidget(self.table_frame_main)
        if (self.table_widget_main.columnCount() < 3):
            self.table_widget_main.setColumnCount(3)
        __qtablewidgetitem = QTableWidgetItem()
        self.table_widget_main.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        self.table_widget_main.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        self.table_widget_main.setHorizontalHeaderItem(2, __qtablewidgetitem2)
        if (self.table_widget_main.rowCount() < 1):
            self.table_widget_main.setRowCount(1)
        __qtablewidgetitem3 = QTableWidgetItem()
        self.table_widget_main.setVerticalHeaderItem(0, __qtablewidgetitem3)
        self.table_widget_main.setObjectName(u"table_widget_main")
        self.table_widget_main.setEnabled(True)
        self.table_widget_main.setMinimumSize(QSize(0, 100))
        self.table_widget_main.horizontalHeader().setCascadingSectionResizes(True)
        self.table_widget_main.horizontalHeader().setMinimumSectionSize(30)
        self.table_widget_main.horizontalHeader().setDefaultSectionSize(170)
        self.table_widget_main.horizontalHeader().setHighlightSections(True)
        self.table_widget_main.horizontalHeader().setProperty(u"showSortIndicator", True)
        self.table_widget_main.horizontalHeader().setStretchLastSection(True)
        self.table_widget_main.verticalHeader().setCascadingSectionResizes(True)
        self.table_widget_main.verticalHeader().setMinimumSectionSize(24)
        self.table_widget_main.verticalHeader().setDefaultSectionSize(30)
        self.table_widget_main.verticalHeader().setProperty(u"showSortIndicator", True)
        self.table_widget_main.verticalHeader().setStretchLastSection(False)

        self.verticalLayout_3.addWidget(self.table_widget_main)
        ...
        self.items_count_main = QComboBox(self.pagination_frame_main)
        self.items_count_main.addItem("")
        self.items_count_main.addItem("")
        self.items_count_main.addItem("")
        self.items_count_main.setObjectName(u"items_count_main")
        self.items_count_main.setMinimumSize(QSize(200, 0))
        self.items_count_main.setMaximumSize(QSize(230, 16777215))

        self.horizontalLayout_3.addWidget(self.items_count_main)
        ...
        self.current_page_main = QLabel(self.pagination_frame_main)
        self.current_page_main.setObjectName(u"current_page_main")
        self.current_page_main.setMinimumSize(QSize(0, 0))
        self.current_page_main.setMaximumSize(QSize(50, 16777215))
        font1 = QFont()
        font1.setFamilies([u"Arial"])
        font1.setPointSize(11)
        self.current_page_main.setFont(font1)
        self.current_page_main.setAlignment(Qt.AlignmentFlag.AlignCenter)

        self.horizontalLayout_3.addWidget(self.current_page_main)
    ...
    def retranslateUi(self, MainWindow):
        ...
        ___qtablewidgetitem1 = self.table_widget_main.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("MainWindow", u"\u0413\u0440\u0443\u043f\u043f\u0430", None));
        ___qtablewidgetitem2 = self.table_widget_main.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"\u042d\u043a\u0437\u0430\u043c\u0435\u043d\u044b", None));
        self.items_count_main.setItemText(0, QCoreApplication.translate("MainWindow", u"5", None))
        self.items_count_main.setItemText(1, QCoreApplication.translate("MainWindow", u"10", None))
        self.items_count_main.setItemText(2, QCoreApplication.translate("MainWindow", u"15", None))

        self.items_count_main.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u041a\u043e\u043b\u0438\u0447\u0435\u0441\u0442\u0432\u043e \u0437\u0430\u043f\u0438\u0441\u0435\u0439 \u043d\u0430 \u0441\u0442\u0440\u0430\u043d\u0438\u0446\u0435", None))
        ...
        self.current_page_main.setText(QCoreApplication.translate("MainWindow", u"1", None))
