...
from .views import MechanismsView, MechanismCreateView, MechanismUpdateView, MechanismDeleteView, MechanismDetachView, MechanismRepairView
...
urlpatterns = [
    ...
    path("repair/<int:mechanism_id>/", MechanismRepairView.as_view(), name="repair_one")
]
